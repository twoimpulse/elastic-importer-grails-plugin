...
package org.grails.plugins.elasticimporter
...
class ElasticImporterConfigurator {
    ...
    public void installMappings(Collection<SearchableClassMapping> mappings){
        ...
        MappingMigrationStrategy migrationStrategy = esConfig?.migration?.strategy ? MappingMigrationStrategy.valueOf(esConfig.migration.strategy) : org.grails.plugins.elasticsearch.mapping.MappingMigrationStrategy.none
    ...
    private boolean createIndexWithReadAndWrite(MappingMigrationStrategy strategy, SearchableClassMapping scm, Map indexSettings) throws RemoteTransportException {
        ...
        if(!es.indexExists(scm.indexName)) {
            ...
            if (strategy == org.grails.plugins.elasticsearch.mapping.MappingMigrationStrategy.alias) {
